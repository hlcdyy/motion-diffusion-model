...
class InpaintingGaussianDiffusion(SpacedDiffusion):
    ...
    def training_losses( 
        ...
        return super().training_stylediffuse_losses(self._wrap_model(model), *args, **kwargs)
    
    def training_inpainting_losses(
            self, model, *args, **kwargs
    ):
        return super().training_losses(self._wrap_model(model), *args, **kwargs)
    
    def few_shot_trans_losses(
            self, model, *args, **kwargs
    ):
        return super().few_shot_trans_losses(self._wrap_model(model), *args, **kwargs)
    
    def ablation_dis_losses(
            self, model, *args, **kwargs
    ):
        return super().ablation_dis_losses(self._wrap_model(model), *args, **kwargs)
